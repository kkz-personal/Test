...
public class TbClass {
	...
	public String toString() {
		return "TbClass [classid=" + classid + ", classname=" + classname + ", classtypeid=" + classtypeid
				+ ", teacherid=" + teacherid + ", classGuideid=" + classGuideid + ", jobGuideid=" + jobGuideid
				+ ", createddate=" + createddate + ", enddate=" + enddate + ", stateid=" + stateid + ", comment="
				+ comment + "]";
	}
